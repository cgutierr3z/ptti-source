...
class FormEditarUsuario(UserChangeForm):
    ...
    class Meta:
        model = Usuario
        fields = ('username','email','first_name','last_name','tipo_docto','no_docto','fecha_nac','genero','direccion','telefono','is_active','is_administrador','is_psicologo','is_estudiante','password')
